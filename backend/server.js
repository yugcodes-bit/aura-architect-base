...
app.post('/api/generate', async (req, res) => {
    try {
              ...
              "items": [
                {
                  ...
                  "qualifiers": ["adjective1", "adjective2"],
                  "placement": "A short placement instruction from the list below"
                }
              ]
            }

            - "name" must be a simple category from this list: chair, sofa, table, lamp, rug, plant, room_base.
        ...
        // --- THIS IS THE NEW, SMARTER CLEANUP LOGIC ---
